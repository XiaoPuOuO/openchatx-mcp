...
- [Project Overview](./pages/project-overview.md) — Mandatory startup context for Shellby MCP: its local-agent-harness mental model, engineering approach, and global runtime and trust boundaries.
