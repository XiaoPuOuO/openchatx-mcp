...
- Transport completion supplies a fallback record only for calls never claimed by a handler, such as validation or dispatch rejections. Remote authorization failures occur before audit request creation.
