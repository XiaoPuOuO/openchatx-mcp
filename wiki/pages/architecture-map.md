...
| MCP execution boundary | Gate initialized sessions, dispatch tools and `then_run`, project results, append notices, and connect audit/observer lifecycles                 | `src/mcp/tool-registration-boundary.ts`  |
