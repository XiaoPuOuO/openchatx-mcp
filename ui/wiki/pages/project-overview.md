...
Dashboard is observer, and visualization layer. Server-side `AgentObserver` owns agent call history and steering instructions. UI adds presentation-only state such as selected modal rows and queued pixel-room animations.
