...
export function shouldStopThenRun(toolName: string, result: unknown): boolean {
  return toolResultFailed(toolName, result)
}

/** Return whether a completed tool result represents a failed operation for orchestration. */
export function toolResultFailed(toolName: string, result: unknown): boolean {
